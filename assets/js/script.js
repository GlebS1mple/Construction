...
const popupCatalogBtn = document.querySelector('.order-btn')
const popupProductBtn = document.querySelector('.popup__productbtn')
const closePopup = document.querySelector(".popup__close")
const closeCatalogPopup = document.querySelector(".popup__closecatalog")
...
const openCatalogPopUp = () => {
    popupCatalog.classList.add('popup__active')
    if (popupCatalog.classList.contains('popup__active')) {
        body.classList.add('no_scroll')
    }
}
popupCatalogBtn.addEventListener('click', openCatalogPopUp)
...
window.onload = function () {
    closeCatalogPopup.addEventListener("click", function () {
        if (popupCatalog.classList.contains("popup__active")) {
            popupCatalog.classList.remove("popup__active")
        }
